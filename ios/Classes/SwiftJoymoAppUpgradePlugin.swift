...
public class SwiftJoymoAppUpgradePlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "joymo_app_upgrade", binaryMessenger: registrar.messenger())
    let instance = SwiftJoymoAppUpgradePlugin()
