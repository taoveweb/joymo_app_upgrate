...
package com.flutter.joymo_app_upgrade
...
public class JoymoAppUpgradePlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    val channel = MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "joymo_app_upgrade")
    channel.setMethodCallHandler(JoymoAppUpgradePlugin())
  }
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      ...
      val channel = MethodChannel(registrar.messenger(), "joymo_app_upgrade")
      channel.setMethodCallHandler(JoymoAppUpgradePlugin())
    }
